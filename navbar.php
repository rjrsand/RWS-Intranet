<!-- Wappler include head-page="index.php" appConnect="local" is="dmx-app" bootstrap5="local" fontawesome_5="cdn" jquery_slim_35="cdn" components="{dmxBootstrap5Navigation:{}}" -->
                    ...
                    <nav class="header-navbar navbar navbar-expand-lg navbar-dark bg-transparent align-items-stretch pt-0 pb-0">
                        ...
                        <div class="collapse navbar-collapse justify-content-end align-items-stretch" id="navbar1_collapse">
                            <div class="d-flex flex-column justify-content-center">
                                ...
                                <small class="text-secondary w-100 text-end mb-0 tile-hover" id="logout-btn">Sign Out.</small>
                            </div>
