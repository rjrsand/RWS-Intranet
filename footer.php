...
<section>
    <h2 class="rounded-circle report-bug-btn text-center text-light bg-dark shadow border tile-hover " dmx-on:click="browser1.goto('https://forms.clickup.com/14351633/f/dnz8h-3730/CWCYVE1OEJSCP24N62')"><i class="fa fa-bug fa-fw ps-1 pb-1"></i></h2>
</section>
