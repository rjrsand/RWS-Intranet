                                ...
                                <div class="row justify-content-center">
                                    <div class="col-lg-7">
                                        <div class="d-flex flex-column">
                                            ...
                                            <button id="btn1" class="btn align-self-center btn-outline-warning lh-lg btn-lg tile-hover active fw-bolder text-body" dmx-on:click="browser1.goto('login.php')" data-bs-toggle="button">Go Home</button>
                                        </div>
                                    </div>
                                </div>
